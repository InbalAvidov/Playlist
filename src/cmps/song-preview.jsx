...
export function SongPreview({ song, idx, station, onDeleteSong, isLikedSongsPage, isSearchPage }) {
        ...
        <Draggable draggableId={isSearchPage ? song._id : song.id} index={idx} key={song.id}>
            {(provided) => (
                ...
                >
                    ...
                    {user && <span onClick={toggleLike} className={isSearchPage ? "song-like search" : "song-like"}>
